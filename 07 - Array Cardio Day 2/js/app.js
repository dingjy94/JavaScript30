...
const someOlder = people.some((person) => 2019 - person.year >= 19);
console.log('is at least one person 19 or older?');
console.log(someOlder);

// Array.prototype.every() // is everyone 19 or older?
const everyOlder = people.every((person) => 2019 - person.year >= 19);
...
const commentFindIndex = comments.findIndex((comment) => comment.id === 823423);
